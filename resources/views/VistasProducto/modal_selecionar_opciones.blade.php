<dialog id="ModalSelecOpc" class="bg-white  w-96 p-8 rounded-lg modalFondo modalOpen">
    <!--bt_cerrar_modal-->
    <button id="bt_cerrar_modal_opc" type="button"
    ...
    <!--div principal-->
    <p class="font-semibold bg-red-700 text-center w-full"> SELECIOE LOS TIPOS DE ADIONES QUE TEGNO ALA TIENDA  </p>
