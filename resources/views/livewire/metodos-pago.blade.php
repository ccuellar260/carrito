    ...
    <div class="w-full bg-white h-full border-t border-gray-200 px-5 py-5 text-gray-800">
        <div class="w-full ">
            <div class="-mx-3 md:flex items-start">
                ...
                <div class="px-3 md:w-7/12 lg:pr-10 border border-gray-200 rounded-lg p-3">
                ...
                <!-- Carrito -->
                <div class="px-3 md:w-5/12" wire:ignore>
                    ...
                    <div>
                        <button
                            class="block w-full max-w-xs mx-auto bg-blue-600 hover:bg-blue-800 focus:bg-blue-800 text-white rounded-lg px-3 py-2 font-semibold disabled:opacity-25"
                            id="card-button"> {{-- data-secret="{{ $intento->client_secret }}" --}}
